#!/usr/bin/env bash
# Measure independent application flows through a local wanopt SOCKS5 node.
...
flow_list=${WANOPT_FLOWS:-"1 2 4 8"}
...
Environment variables with WANOPT_ prefixes provide the same defaults.
