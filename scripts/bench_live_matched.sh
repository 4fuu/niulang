...
a_proxy=${WANOPT_A_PROXY:-127.0.0.1:12140}
b_proxy=${WANOPT_B_PROXY:-127.0.0.1:12141}
a_label=${WANOPT_A_LABEL:-wanopt}
b_label=${WANOPT_B_LABEL:-reference}
url=${WANOPT_URL:-}
expected_bytes=${WANOPT_EXPECTED_BYTES:-10485760}
rounds=${WANOPT_ROUNDS:-5}
timeout_seconds=${WANOPT_TIMEOUT_SECONDS:-120}
